...
class Search extends Component {
    ...
    render() {
        ...
        const blogResults = this.state.blogResults.map((current, index) => <BlogTile key={index} blog={current} />)
        const userResults = this.state.userResults.map((current, index) => <UserTile key={index} user={current} />)
